...
public class DueDateCalculatorTest {
    ...
    public void testCreateAndConvert() {
        ...
        assertThat(dueDateCalculator.getIssue().getSubmitDateTime().getHour(),equalTo(15));
        assertThat(dueDateCalculator.getIssue().getTurnAroundTimeInSeconds(),equalTo(3600L));
    }
    ...
    public void testWeekend1() {
        Issue issue = new Issue(submitDateTime, turnAroundTime1);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        assertFalse(dueDateCalculator.isWeekend(issue.getSubmitDateTime()));
    }
    ...
    public void testWeekend2() {
        ...
        assertTrue(dueDateCalculator.isWeekend(submitDateTime.getSubmitDateTime()));
    }
    ...
    public void testWorkingTime1() {
        Issue issue = new Issue(submitDateTime, turnAroundTime1);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        assertTrue(dueDateCalculator.isWorkingTime(issue.getSubmitDateTime()));
    }
    ...
    public void testWorkingTime2() {
        ...
        assertFalse(dueDateCalculator.isWorkingTime(submitDateTime.getSubmitDateTime()));
    }
    ...
    public void testMorningOfNextWorkday() {
        Issue issue = new Issue(submitDateTime, turnAroundTime2);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        submitDateTime = dueDateCalculator.calculateSubmitDateTimeOfMorningOfNextWorkday(submitDateTime.getSubmitDateTime());
    ...
    public void testMorningOfNextWorkdayWeekend() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        submitDateTimeFriday = dueDateCalculator.calculateSubmitDateTimeOfMorningOfNextWorkday(submitDateTimeFriday.getSubmitDateTime());
    ...
    public void testSubmitDateTimeOutsideWorkingHours() {
        ...
        Issue issue = new Issue(submitDateTime, turnAroundTime1);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        AssertionError assertionError = assertThrows(AssertionError.class, () -> dueDateCalculator.calculateDueDate(issue));
    ...
    public void testDueToday() {
        Issue issue = new Issue(submitDateTime, turnAroundTime1);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        assertTrue(dueDateCalculator.isDueToday(issue));
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusHours(1)));
    }
    ...
    public void testDueTomorrow() {
        Issue issue = new Issue(submitDateTime, turnAroundTime2);
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        assertFalse(dueDateCalculator.isDueToday(issue));
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusHours(18)));
    }
    ...
    public void testDueFriday() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusDays(3).plusHours(1)));
    }
    ...
    public void testDueNextWeek() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusWeeks(1).plusHours(1)));
    }
    ...
    public void testLongWork() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusWeeks(2).plusDays(2).plusHours(1)));
    }
    ...
    public void testThirtyMinutes() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusMinutes(30)));
    }
    ...
    public void testTenMinutes() {
        ...
        DueDateCalculator dueDateCalculator = new DueDateCalculator(issue);
        DueDate dueDate = dueDateCalculator.calculateDueDate(issue);
        assertThat(dueDate.getDueDate(),equalTo(submitDateTime.getSubmitDateTime().plusMinutes(10)));
    }
}
